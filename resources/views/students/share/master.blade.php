...
<body class="sidebar-main-active right-column-fixed header-top-bgcolor">
    ...
    <div class="wrapper">
        ...
        @include('students.share.menu')

        <!-- TOP Nav Bar -->

        @include('students.share.header')
        ...
        <div id="content-page" class="content-page">
           {{-- @include('students.share.body') --}}
           @yield('noi_dung')
        </div>
    </div>

    @include('students.share.right')
