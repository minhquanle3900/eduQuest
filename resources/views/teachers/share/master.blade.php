...
<body class="sidebar-main-active right-column-fixed header-top-bgcolor">
    ...
    <div class="wrapper">
        ...
        @include('teachers.share.menu')

        <!-- TOP Nav Bar -->

        @include('teachers.share.header')
        ...
        <div id="content-page" class="content-page">
           {{-- @include('teachers.share.body') --}}
           @yield('noi_dung')
        </div>
    </div>

    @include('teachers.share.right')
