    ...
    <div id="sidebar-scrollbar">
       <nav class="iq-sidebar-menu">
          <ul id="iq-sidebar-toggle" class="iq-menu">
             <li class="iq-menu-title"><i class="ri-subtract-line"></i><span>DEAN PAGE</span></li>
             <li class="active">
             ...
             <li class="">
                ...
                <ul id="menu-design" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                   <li><a href="horizontal-menu.html"><i class="ri-git-commit-line"></i>QUẢN LÝ BỘ MÔN</a></li>
                   <li><a href="horizontal-menu.html"><i class="ri-git-commit-line"></i>...</a></li>
                   <li><a href="horizontal-menu.html"><i class="ri-git-commit-line"></i>...</a></li>
